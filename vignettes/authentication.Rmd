...
Reneweing means getting a new secret, not a whole new client, meaning the client will retain access to all the forms you have added it to, and you won't need to re-do that part of the work.
...
![Screenshot of the Nettskjema Authorization portal. The three dots in the My clients table have been clicked for a client row, and a menu is opened showing the options: Edit, Renew, Delete, Editors.](static/client_renew.png)
