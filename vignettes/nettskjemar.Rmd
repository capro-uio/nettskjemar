...
Nettskjemar connects to version 2 of the [nettskjema api](www.nettskjema.no), and the main functionality here is to download data from a form into R.
...
There are many arguments that can be set that give you control over the data extration. 
...
If the codebook has not been set up, initial download will fail because there is none, and the user must toggle this themselves. 
