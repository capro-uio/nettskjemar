...
data
#>   formid $submission_id                  $created  freetext
#> 1 123823       27685292 2023-06-01T20:57:15+02:00 some text
...
#> 1                    2                  2
#>   checkbox_matrix.1.IT checkbox_matrix.1.colleague
#> 1                    1                           1
#>   checkbox_matrix.1.admin checkbox_matrix.1.union
#> 1                       0                       0
#>   checkbox_matrix.1.internet checkbox_matrix.2.IT
#> 1                          0                    0
#>   checkbox_matrix.2.colleague checkbox_matrix.2.admin
#> 1                           0                       1
#>   checkbox_matrix.2.union checkbox_matrix.2.internet
#> 1                       0                          0
#>         date  time         datetime number_decimal
#> 1 2023-06-01 12:00 2023-06-12T13:33            4.5
...
#> 1 2023-06-01T20:57:15           NA                 NA
#> 2 2023-06-01T20:57:15           NA                 NA
#>   filename mediaType size attachment.answerAttachmentId
#> 1     <NA>      <NA>   NA                            NA
#> 2     <NA>      <NA>   NA                            NA
...
#> 1                   1                    2
#> 2                   3                    3
#>   radio_matrix.email       date  time         datetime
#> 1                  2 2023-06-01 12:00 2023-06-12T13:33
#> 2                  1 2023-02-07 14:45 2024-02-15T08:55
#>   number_decimal number_integer slider attachment_1
#> 1            4.5           77.0      3    sølvi.png
#> 2            2.2           45.0      1             
#>   attachment_2 $answer_time_ms checkbox_matrix.1
#> 1                        74630     colleague, IT
#> 2  marius.jpeg           71313          internet
#>   checkbox_matrix.2
#> 1             admin
#> 2      admin, union
...
#>   checkbox.questionnaires checkbox.events checkbox.logs
#> 1                       1               1             0
#> 2                       0               0             1
#>   dropdown radio_matrix.grants radio_matrix.lecture
#> 1        4                   1                    2
#> 2        9                   3                    3
#>   radio_matrix.email       date  time         datetime
#> 1                  2 2023-06-01 12:00 2023-06-12T13:33
...
#>              <int>  <dbl> <chr>             <chr>           
#> 1         27685292 123823 colleague         2023-06-01T20:5…
#> 2         27685292 123823 IT                2023-06-01T20:5…
#> 3         27685302 123823 internet          2023-06-01T20:5…
#> 4         27685319 123823 colleague         2023-06-01T20:5…
#> 5         27685319 123823 internet          2023-06-01T20:5…
#> # ℹ 19 more variables: freetext <chr>, radio <int>,
#> #   checkbox.questionnaires <int>, checkbox.events <int>,
#> #   checkbox.logs <int>, dropdown <int>,
#> #   radio_matrix.grants <int>, radio_matrix.lecture <int>,
#> #   radio_matrix.email <int>, date <chr>, time <chr>,
#> #   datetime <chr>, number_decimal <chr>,
#> #   number_integer <chr>, slider <int>, …
```
