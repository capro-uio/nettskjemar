...
To see which forms you have access to, use the `nskj_get_forms` function.
...
#> 2 2025-03-11T11:46:20 2025-03-11T09:56:21
...
raw_forms <- nskj_get_forms(asis = TRUE)
...
Use the `nskj_get_form_reports` function to download these reports.
...
nskj_get_form_reports(form_id, type = "csv")
...
nskj_get_form_reports(form_id, type = "excel")
```
...
nskj_get_form_reports(form_id, type = "spss", path = path)
```
