...
#> 
#> $radio
#> [1] "How happy are we with Nettskjema?"
#> 
#> $checkbox.questionnaires
#> [1] "What do we use it for?:: Questionnaires"
#> 
#> $checkbox.events
#> [1] "What do we use it for?:: Event sign-ups"
#> 
#> $checkbox.logs
#> [1] "What do we use it for?:: Data logging"
#> 
#> $dropdown
#> [1] "Who is responsible with Nettskjema?"
#> 
#> $radio_matrix.grants
#> [1] "In the last month I have: written some grant applications"
#> 
#> $radio_matrix.lecture
#> [1] "In the last month I have: held a lecture"
#> 
#> $radio_matrix.email
#> [1] "In the last month I have: sent some e-mails"
#> 
#> $checkbox_matrix.1.IT
#> [1] "In the last year, I have :: sought help from :: IT"
#> 
#> $checkbox_matrix.1.colleague
#> [1] "In the last year, I have :: sought help from :: A colleague"
#> 
#> $checkbox_matrix.1.admin
#> [1] "In the last year, I have :: sought help from :: Administration"
#> 
#> $checkbox_matrix.1.union
#> [1] "In the last year, I have :: sought help from :: Union"
#> 
#> $checkbox_matrix.1.internet
#> [1] "In the last year, I have :: sought help from :: Internet"
#> 
#> $checkbox_matrix.2.IT
#> [1] "In the last year, I have :: received e-mails from :: IT"
#> 
#> $checkbox_matrix.2.colleague
#> [1] "In the last year, I have :: received e-mails from :: A colleague"
#> 
#> $checkbox_matrix.2.admin
#> [1] "In the last year, I have :: received e-mails from :: Administration"
#> 
#> $checkbox_matrix.2.union
#> [1] "In the last year, I have :: received e-mails from :: Union"
#> 
#> $checkbox_matrix.2.internet
#> [1] "In the last year, I have :: received e-mails from :: Internet"
#> 
#> $date
#> [1] "Choose a random date"
#> 
#> $time
#> [1] "now choose a random time!"
#> 
#> $datetime
#> [1] "Lastly choose a date AND time!"
#> 
#> $number_decimal
#> [1] "Pick a number between 0 and 10!"
#> 
#> $number_integer
#> [1] "Choose an integer between 0 and 100"
#> 
#> $slider
#> [1] "Choose a point on the slider!"
#> 
#> $attachment_1
#> [1] "Upload a fun image!"
#> 
#> $attachment_2
#> [1] "This is an attachment2"
#> 
#> $`$answer_time_ms`
#> NULL
```
