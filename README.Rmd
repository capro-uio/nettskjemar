...
There is a tutorial on [how to create an API client](https://CAPRO-UIO.github.io/nettskjemar/articles/authentication.html) needed to work with the api.
...
```
Package documentation can be found on the associated [GitHub pages](https://CAPRO-UIO.github.io/nettskjemar/), where there are `r length(vigs)` tutorials.
