...
<!-- badges: start -->
[![R build status](https://github.com/CAPRO-UIO/nettskjemar/workflows/R-CMD-check/badge.svg)](https://github.com/CAPRO-UIO/nettskjemar/actions)
...
There is a tutorial on [how to create the API access user and token](https://CAPRO-UIO.github.io/nettskjemar/articles/auth_setup.html) needed to work with the api.
...
## Documentation
Package documentation can be found on the associated [GitHub pages](https://CAPRO-UIO.github.io/nettskjemar/), among other documentation on [how to create the API access user and token](https://CAPRO-UIO.github.io/nettskjemar/articles/auth_setup.html).
